    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 64 64" fill="none" stroke="white" strokeWidth="2.5" className="w-10 h-10">
                ...
                <polyline points="37,46 39,48 43,44" stroke="#164e63" strokeWidth="2" />
            </svg>
        ),
...
export default function VoipLanding() {
    ...
    return (
        <div className="min-h-screen max-w-8xl mx-auto w-full bg-white font-sans flex flex-col">
            ...
            <main className="flex-1 flex flex-col lg:flex-row items-center gap-20 px-6 md:px-12 lg:px-20 py-16 w-full">
                ...
                <div className="flex-1 flex flex-col gap-7 lg:pr-8">
                    ...
                    <h1 className="font-['Syne',sans-serif] text-4xl md:text-[2.6rem] leading-[1.2] tracking-tight text-gray-700">
                        Talk Smarter, <span className="text-[#0891b2]">Connect Faster</span>
                    </h1>
                    ...
                    <div className="flex flex-wrap gap-4 mt-2">
                        <button className="flex items-center gap-2 bg-[#0891b2] hover:bg-[#0e7490] text-white font-bold px-7 py-3.5 transition-all shadow-lg text-sm">
                        ...
                        <button className="flex items-center gap-2 border-2 border-gray-200 hover:border-[#0891b2] text-gray-700 font-bold px-7 py-3.5 transition-all text-sm group">
                            <span className="w-8 h-8 rounded-full bg-cyan-50 flex items-center justify-center group-hover:bg-cyan-100 transition-colors">
                ...
                <div className="flex-1 flex flex-col items-center gap-8 w-full max-w-[550px]">
                        ...
                        {tabs.map((tab, i) => (
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        backgroundColor: activeTab === i ? "#ffffff" : "#ecfeff",
                    ...
                    <div
                        ...
                        style={{
                            background: `linear-gradient(135deg, ${tabs[activeTab].color}, #0891b2)`
                        }}
                    >
